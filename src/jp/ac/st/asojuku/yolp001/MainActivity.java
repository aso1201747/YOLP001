...
public class MainActivity extends Activity implements LocationListener {
	...
	public void onLocationChanged(Location location) {
		...
		// 緯度と経度のいずれかが直前の値と誤差が出れば、画面を更新(100で割って元々の緯度経度小数4桁、100mくらいの誤差にする)
	...
	@Override
	public void onProviderDisabled(Stirng provider) {
		// TODO 自動生成されたメソッド・スタブ

	}

	@Override
	public void onProviderEnabled(Stirng provider) {
		// TODO 自動生成されたメソッド・スタブ
	...
	protected void onResume() {
		...
		// 位置測定のためにGPS精度や使用消費電力を設定するふるいにかけるためにCriteriaオブジェクトを生成
